  ...
  return (
    ...
    >
      ...
      <motion.div 
        ...
        className="sticky top-0 z-50 bg-white/60 dark:bg-[#0d1117]/80 backdrop-blur-md shadow-sm p-4 flex items-center gap-3 border-b border-white/10"
      >
        <Button
          onClick={() => router.back()}
          variant="ghost"
      ...
      <motion.div 
        ...
        className="px-4 py-6 pb-8 space-y-6 max-w-md mx-auto"
      >
        {/* User Info Card */}
        <motion.div
