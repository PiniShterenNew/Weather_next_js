import { render, screen, fireEvent, within } from '@/test/utils/renderWithIntl'
...
describe('WeatherListItem', () => {
  ...
  it('displays humidity, wind and visibility metrics', () => {
    ...
    expect(within(root).getByText(/3.5 km\/h E/)).toBeInTheDocument()
    expect(within(root).getByText(/10 km/)).toBeInTheDocument()
  })
})
